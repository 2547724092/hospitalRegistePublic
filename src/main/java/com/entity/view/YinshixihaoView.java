...
public class YinshixihaoView extends YinshixihaoEntity implements Serializable {
	...
	* 食物类型的值
	*/
	@ColumnInfo(comment="食物类型的字典表值",type="varchar(200)")
	private String yinshixihaoValue;
	...
	public YinshixihaoView() {

	}

	public YinshixihaoView(YinshixihaoEntity yinshixihaoEntity) {
		try {
			BeanUtils.copyProperties(this, yinshixihaoEntity);
	...
	* 获取： 食物类型的值
	*/
	public String getYinshixihaoValue() {
		return yinshixihaoValue;
	}
	/**
	* 设置： 食物类型的值
	*/
	public void setYinshixihaoValue(String yinshixihaoValue) {
		this.yinshixihaoValue = yinshixihaoValue;
	}
	...
	public String toString() {
		return "YinshixihaoView{" +
			", yinshixihaoValue=" + yinshixihaoValue +

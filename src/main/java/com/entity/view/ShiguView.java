...
public class ShiguView extends ShiguEntity implements Serializable {
	...
	* 事故类型的值
	*/
	@ColumnInfo(comment="事故类型的字典表值",type="varchar(200)")
	private String shiguValue;
	/**
	* 严重程度的值
	*/
	@ColumnInfo(comment="严重程度的字典表值",type="varchar(200)")
	private String yanzhengValue;
	...
	* 获取： 严重程度的值
	*/
	public String getYanzhengValue() {
		return yanzhengValue;
	}
	/**
	* 设置： 严重程度的值
	*/
	public void setYanzhengValue(String yanzhengValue) {
		this.yanzhengValue = yanzhengValue;
	}

...
public class FangkeView extends FangkeEntity implements Serializable {
	...
	* 来访目的的值
	*/
	@ColumnInfo(comment="来访目的的字典表值",type="varchar(200)")
	private String fangkeValue;
	...
	* 获取： 来访目的的值
	*/
	public String getFangkeValue() {
		return fangkeValue;
	}
	/**
	* 设置： 来访目的的值
	*/
	public void setFangkeValue(String fangkeValue) {
		this.fangkeValue = fangkeValue;
	}

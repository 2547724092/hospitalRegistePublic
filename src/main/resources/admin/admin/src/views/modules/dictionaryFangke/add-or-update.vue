<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="来访目的编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="来访目的编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="来访目的编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="来访目的编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="来访目的" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="来访目的" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="来访目的" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
        ...
        methods: {
            ...
            onSubmit() {
                if((!this.ruleForm.indexName)){
                    this.$message.error('来访目的不能为空');
                    return
                }
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        let ruleForm = this.ruleForm;
                        ruleForm["dicCode"]="fangke_types";
                        ruleForm["dicName"]="来访目的";
                        this.$http({
